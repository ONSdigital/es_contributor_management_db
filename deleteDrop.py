...
def main():
    ...
    make_list = ['create table es_db_test.SSR_Old_Regions (IDBR varchar(2) not null, SSRReference smallint, RegionName varchar(255), primary key (IDBR));',
                 ...
                 'create table es_db_test.VET (VET int not null, Description varchar(255) not null, primary key (VET));',
                 ...
                 'create table es_db_test.Contributor (ParentRUReference varchar(11) not null, RUReference varchar(11) not null, HouseNameNo varchar(50) not null, Street varchar(100) not null, AdditionalAddressLine varchar(100), TownCity varchar(60) not null, County varchar(50) not null, Country varchar(55), Postcode varchar(9) not null, BirthDate date not null, BusinessProfilingTeamCase boolean not null, Contact varchar(255) not null, DeathDate date, EnforcementFlag boolean, EnforcementStatus varchar(255), Fax varchar(25), ContributorName varchar(255), ProfileInformation text, SIC2003 int, SIC2007 int, Telephone varchar(25), primary key (RUReference));',
